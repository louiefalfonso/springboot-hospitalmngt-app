      ...
      <React.Fragment>
        ...
        >
          <div className="h-full bg-white dark:bg-darklight">
            <div className="p-4">
              <Link to="index" className="w-full h-10 main-logo">
                <img
                  src={logo}
                  className="mx-auto dark-logo logo  h-12  dark:hidden"
                  alt="logo"
                />
                <img
                  src={logo}
                  className="hidden mx-auto light-logo h-10 logo dark:block"
                  alt="logo"
                />
              </Link>
            </div>
